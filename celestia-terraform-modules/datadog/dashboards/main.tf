...
# Resource: Datadog Dashboard for Celestia Network Monitoring
# Description: This Terraform resource dynamically creates and manages a Datadog dashboard tailored for showcasing 
# various metrics associated with the Celestia Nodes. It leverages a dynamic approach using the `for_each` construct 
...
resource "datadog_dashboard_json" "celestia_dashboards" {
